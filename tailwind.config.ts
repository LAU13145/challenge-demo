...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        primaryColmena: '#0097AE',
        primaryColmena_2: '#F9B036',
        primaryColmena_3: '#FEC82F',
      ...
      backgroundImage: {
        'main-backgroundImg': 'url("../assets/publicAssets/mainBackgroundImg.png")',
      },
    },
  },
  plugins: [require('flowbite/plugin'), require('@nextui-org/theme')],
}
