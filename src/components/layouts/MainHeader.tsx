  ...
  return (
      <header className='flex flex-col'>
        <div className='flex justify-center gap-4 items-center m-4'>
          ...
          <h1 className='text-slate-800 text-base text-center md:text-xl font-bold md:tracking-wide md:w-80 xl:text-2xl'>Simulador de Certificados de Depósito a Término</h1>
        </div>
